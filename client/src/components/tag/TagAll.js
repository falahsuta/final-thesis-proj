  ...
  return (
    <>
      {tags && tags.length > 0 && <Paper>
        ...
        >
          <Grid items xs={4}>
            <Column gap={2}>{renderTag(tags.slice(0,3))}</Column>
          </Grid>
          <Grid items xs={4}>
            <Column gap={2}>{renderTag(tags.slice(3,6))}</Column>
          </Grid>
          <Grid items xs={4}>
            <Column gap={2}>{renderTag(tags.slice(6,10))}</Column>
          </Grid>
        </Grid>
        <div
